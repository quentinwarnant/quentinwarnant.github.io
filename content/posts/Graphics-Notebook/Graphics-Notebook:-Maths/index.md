...
- Full circle is 2 * PI _radians_ units
...
- Imaginary number _i_ (i = i, i² = -1, i³ = -i, i⁴ = 1)

## Calculus
- The maths studying _change_
...
Differential equations come up in fluid simulation & physics effects.
For example, when calculating the how much velocity flowed into a cell, we take the integral of the velocity over the distance between two cells. (v / dx)
